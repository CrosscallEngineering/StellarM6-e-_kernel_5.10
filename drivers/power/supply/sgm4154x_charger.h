...
#define SGM4154x_VDPM_TRACK_MASK	GENMASK(1, 0)
...
#define SGM4154x_VRECHRG_DEFAULT_mV		200
...
#define SGM4154x_PRECHRG_I_DEF_uA		240000
#define SGM4155x_PRECHRG_I_DEF_uA		80000
...
#define SGM4155x_TERMCHRG_I_DEF_uA		30000
...
/*charge faults*/
#define SGM4154x_CHRG_FAULT_MASK		GENMASK(5, 4)
#define SGM4154x_CHRG_FAULT_CHRG_SAFETY_TIMER_EXPIRED	(BIT(5) | BIT(4))

/*dev rev*/
#define SGM4154x_DEV_REV_MASK       GENMASK(1, 0)
...
struct sgm4154x_init_data {
	...
	u32 ovp_thd;	/*over voltage protection threshold*/
	u32 rechg_thd;	/*recharge voltage*/
	u32 iboost;	/*boost current limit*/
	u32 vboost;	/*boost voltage limit*/
	u32 max_ichg;
	u32 max_vreg;
};
...
struct sgm4154x_jeita {
	...
	int jeita_temp_t0_to_t1_cc_current;
...
struct sgm4154x_monitored_items{
	u8 health;
...
struct sgm4154x_device {
	...
	struct sgm4154x_monitored_items monitored_items;
	u32 watchdog_timer;
	...
	struct delayed_work otg_detect_delayed_work;
	struct delayed_work charge_monitor_work;
	struct delayed_work recharge_delayed_work;
	struct delayed_work init_typec_class_delay_work;
