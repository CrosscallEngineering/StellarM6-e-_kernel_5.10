...
#ifdef CONFIG_PANIC_HANDLE
#include <linux/his_debug_base.h>
#endif /*CONFIG_PANIC_HANDLE*/
...
#ifdef CONFIG_PANIC_HANDLE
#define PON_PBS_RESIN_S2_CTL2		0x47
#define PON_PBS_RESIN_S2_ENABLE		BIT(7)
#endif /*CONFIG_PANIC_HANDLE*/
...
#ifdef CONFIG_PANIC_HANDLE
	if((pwrkey->data->status_bit & PON_GEN3_RESIN_N_SET)
			&& pwrkey->data->has_pon_pbs){
		if(!get_debug_flag_bit(DEBUG_ENABLE_BIT))
			regmap_update_bits(pwrkey->regmap,
				   pwrkey->pon_pbs_baseaddr + PON_PBS_RESIN_S2_CTL2,
				   PON_PBS_RESIN_S2_ENABLE,
				   0);
	}
#endif /*CONFIG_PANIC_HANDLE*/
