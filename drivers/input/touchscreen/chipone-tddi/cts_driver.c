...
#endif /* CONFIG_TOUCHSCREEN_CHIPONE_GESTURE */
...
#define SEPARATION_LINE \
    ...
    count += scnprintf(buf + count, PAGE_SIZE - count,
        "%-32s: %c\n", "CONFIG_TOUCHSCREEN_CHIPONE_GLOVE",
    ...
    count += scnprintf(buf + count, PAGE_SIZE - count,
        "%-32s: %c\n", "CONFIG_TOUCHSCREEN_CHIPONE_GESTURE",
#ifdef CONFIG_TOUCHSCREEN_CHIPONE_GESTURE
       'Y'
#else
       'N'
