...
const struct proc_ops cpuid_dbgfs_cpuid_ops = {
	.proc_read = cpuid_dbgfs_read_cpuid,
};
const struct proc_ops fuse_dbgfs_fuse_ops = {
	.proc_read = fuse_dbgfs_read_fuse,
};
